...
!function (e, t) {
  ...
  return function (e) {
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      for (let s = 0; s < t; s += 8192) {
        const n = Math.min(s + 8192, t),
              i = e.subarray(s, n);
      ...
      if ("string" != typeof e) return i("The argument for removeNullCharacters must be a string."), e;
      return e.replace(h, "");
      ...
      const t = e.length,
            r = [];
      if ("þ" === e[0] && "ÿ" === e[1]) for (let s = 2; s < t; s += 2) r.push(String.fromCharCode(e.charCodeAt(s) << 8 | e.charCodeAt(s + 1)));else if ("ÿ" === e[0] && "þ" === e[1]) for (let s = 2; s < t; s += 2) r.push(String.fromCharCode(e.charCodeAt(s + 1) << 8 | e.charCodeAt(s)));else for (let s = 0; s < t; ++s) {
    ...
    function getDocument(e) {
      ...
      for (const e in r) if ("url" !== e || "undefined" == typeof window) {
        if ("range" !== e) {
          if ("worker" !== e) {
            if ("data" !== e || r[e] instanceof Uint8Array) s[e] = r[e];else {
              const t = r[e];
              if ("string" == typeof t) s[e] = (0, _util.stringToBytes)(t);else if ("object" != typeof t || null === t || isNaN(t.length)) {
    ...
    class PDFPageProxy {
      ...
      getOperatorList() {
        ...
        const e = this.intentStates.oplist;
        let t;
        return e.opListReadCapability || (t = {}, t.operatorListChanged = function () {
          if (e.operatorList.lastChunk) {
            e.opListReadCapability.resolve(e.operatorList);
            const r = e.renderTasks.indexOf(t);
            r >= 0 && e.renderTasks.splice(r, 1);
          }
        }, e.opListReadCapability = (0, _util.createPromiseCapability)(), e.renderTasks = [], e.renderTasks.push(t), e.operatorList = {
          fnArray: [],
          argsArray: [],
          lastChunk: !1
        }, this._stats && this._stats.time("Page Request"), this._pumpOperatorList({
          pageIndex: this._pageIndex,
          intent: "oplist"
        })), e.opListReadCapability.promise;
      }
      ...
      postMessage(e, t) {
        ...
        const r = new WeakMap(),
          ...
          data: function e(s) {
            ...
            if ((n = s.buffer) && (0, _util.isArrayBuffer)(n)) {
              return i = t && t.includes(n) ? new s.constructor(n, s.byteOffset, s.byteLength) : new s.constructor(s), r.set(s, i), i;
            }
            ...
            for (const t in s) {
              ...
              if (void 0 !== r.value) if ("function" != typeof r.value) i[t] = e(r.value);else if (s.hasOwnProperty && s.hasOwnProperty(t)) throw new Error(`LoopbackPort.postMessage - cannot clone: ${s[t]}`);
            }
    ...
    const PDFWorker = function PDFWorkerClosure() {
      ...
      if (_is_node.isNodeJS && "function" == typeof require) isWorkerDisabled = !0, fallbackWorkerSrc = "./pdf.worker.js";else if ("object" == typeof document && "currentScript" in document) {
          ...
          if ("undefined" != typeof Worker && !isWorkerDisabled && !getMainThreadWorkerMessageHandler()) {
            ...
            try {
              ...
              t.addEventListener("error", n), r.on("test", e => {
                ...
                if (t.removeEventListener("error", n), this.destroyed) s();else try {
                  i();
                } catch (e) {
          ...
          n.onload = function () {
            const {
              ...
              height: s
                  ...
                  i = e * s,
                  a = 4 * i,
                  o = new Uint8ClampedArray(i * t);
            let l = document.createElement("canvas");
            l.width = e, l.height = s;
            let c = l.getContext("2d");
            c.drawImage(n, 0, 0);
            const h = c.getImageData(0, 0, e, s).data;
            if (3 === t) for (let e = 0, t = 0; e < a; e += 4, t += 3) o[t] = h[e], o[t + 1] = h[e + 1], o[t + 2] = h[e + 2];else if (1 === t) for (let e = 0, t = 0; e < a; e += 4, t++) o[t] = h[e];
            r({
              data: o,
              width: e,
              height: s
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      const a = (0, s.removeNullCharacters)(t);
      i ? e.href = e.title = a : (e.href = "", e.title = `Disabled: ${a}`, e.onclick = () => !1);
      let l = "";
      ...
      e.target = l, e.rel = "string" == typeof n ? n : "noopener noreferrer nofollow";
    }, t.getFilenameFromUrl = function (e) {
      const t = e.indexOf("#"),
            r = e.indexOf("?"),
            s = Math.min(t > 0 ? t : e.length, r > 0 ? r : e.length);
      return e.substring(e.lastIndexOf("/", s) + 1, s);
    }, t.isFetchSupported = l, t.isValidFetchUrl = c, t.loadScript = function (e) {
    ...
    t.DOMCMapReaderFactory = class {
      ...
      async fetch({
        ...
        return l() && c(t, document.baseURI) ? fetch(t).then(async e => {
    ...
    t.DOMSVGFactory = class {
      create(e, t) {
        ...
        const r = document.createElementNS(n, "svg:svg");
      ...
      createElement(e) {
        return (0, s.assert)("string" == typeof e, "Invalid SVG element type"), document.createElementNS(n, e);
      }
    ...
    class a extends s.BaseException {
      constructor(e, t) {
        super(e), this.type = t;
      }
    ...
    t.PDFDateString = class {
      static toDateObject(e) {
        ...
        return u = u >= 0 && u <= 59 ? u : 0, "-" === c ? (a += d, o += u) : "+" === c && (a -= d, o -= u), new Date(Date.UTC(r, n, i, a, o, l));
      }
    ...
    t.FontLoader = i, t.FontLoader = i = class extends n {
      ...
      _prepareFontLoadEvent(e, t, r) {
        ...
        for (a = 0, o = d.length - 3; a < o; a += 4) p = p - 1482184792 + n(d, a) | 0;

        a < d.length && (p = p - 1482184792 + n(d + "XXX", a) | 0), u = i(u, 16, 4, (0, s.string32)(p));
        const g = `@font-face {font-family:"${d}";src:${`url(data:font/opentype;base64,${btoa(u)});`}}`;
        this.insertRule(g);
        const f = [];

        for (a = 0, o = t.length; a < o; a++) f.push(t[a].loadedName);

        f.push(d);
        const m = document.createElement("div");

        for (m.style.visibility = "hidden", m.style.width = m.style.height = "10px", m.style.position = "absolute", m.style.top = m.style.left = "0px", a = 0, o = f.length; a < o; ++a) {
          const e = document.createElement("span");
          e.textContent = "Hi", e.style.fontFamily = f[a], m.appendChild(e);
        }
    ...
    var a = function () {
      ...
      return e.prototype = {
        getCanvas: function (e, t, r, s) {
          var n;
          return void 0 !== this.cache[e] ? (n = this.cache[e], this.canvasFactory.reset(n, t, r), n.context.setTransform(1, 0, 0, 1, 0, 0)) : (n = this.canvasFactory.create(t, r), this.cache[e] = n), s && i(n.context), n;
        },
    ...
    var o = function () {
      ...
      return e.prototype = {
        ...
        l = function () {
      function e(e, t, r, s, n, l) {
        this.ctx = e, this.current = new o(), this.stateStack = [], this.pendingClip = null, this.pendingEOFill = !1, this.res = null, this.xobjs = null, this.commonObjs = t, this.objs = r, this.canvasFactory = s, this.webGLContext = n, this.imageLayer = l, this.groupStack = [], this.processingType3 = null, this.baseTransform = null, this.baseTransformStack = [], this.groupLevel = 0, this.smaskStack = [], this.smaskCounter = 0, this.tempSMask = null, this.cachedCanvases = new a(this.canvasFactory), e && i(e), this._cachedGetSinglePixelWidth = null;
      }
      ...
      function t(e, t) {
        if ("undefined" != typeof ImageData && t instanceof ImageData) e.putImageData(t, 0, 0);else {
          ...
          if (t.kind === s.ImageKind.GRAYSCALE_1BPP) {
            var A = f.byteLength,
                b = new Uint32Array(m.buffer, 0, m.byteLength >> 2),
                _ = b.length,
                y = c + 7 >> 3,
                v = 4294967295,
                S = s.IsLittleEndianCached.value ? 4278190080 : 255;

            for (n = 0; n < u; n++) {
              for (a = n < d ? 16 : h, r = 0, i = 0; i < a; i++) {
                for (var x = A - g, C = 0, k = x > y ? c : 8 * x - 7, R = -8 & k, w = 0, P = 0; C < R; C += 8) P = f[g++], b[r++] = 128 & P ? v : S, b[r++] = 64 & P ? v : S, b[r++] = 32 & P ? v : S, b[r++] = 16 & P ? v : S, b[r++] = 8 & P ? v : S, b[r++] = 4 & P ? v : S, b[r++] = 2 & P ? v : S, b[r++] = 1 & P ? v : S;

                for (; C < k; C++) 0 === w && (P = f[g++], w = 128), b[r++] = P & w ? v : S, w >>= 1;
              }

              for (; r < _;) b[r++] = 0;

              e.putImageData(p, 0, 16 * n);
            }
          } else if (t.kind === s.ImageKind.RGBA_32BPP) {
            for (i = 0, o = 16 * c * 4, n = 0; n < d; n++) m.set(f.subarray(g, g + o)), g += o, e.putImageData(p, 0, i), i += 16;

            n < u && (o = c * h * 4, m.set(f.subarray(g, g + o)), e.putImageData(p, 0, i));
          } else {
            if (t.kind !== s.ImageKind.RGB_24BPP) throw new Error(`bad image kind: ${t.kind}`);

            for (o = c * (a = 16), n = 0; n < u; n++) {
              for (n >= d && (o = c * (a = h)), r = 0, i = o; i--;) m[r++] = f[g++], m[r++] = f[g++], m[r++] = f[g++], m[r++] = 255;
      ...
      function r(e, t) {
        for (var r = t.height, s = t.width, n = r % 16, i = (r - n) / 16, a = 0 === n ? i : i + 1, o = e.createImageData(s, 16), l = 0, c = t.data, h = o.data, d = 0; d < a; d++) {
          for (var u = d < i ? 16 : n, p = 3, g = 0; g < u; g++) for (var f = 0, m = 0; m < s; m++) {
            if (!f) {
              var A = c[l++];
              f = 128;
            }

            h[p] = A & f ? 0 : 255, p += 4, f >>= 1;
          }
      ...
      function h(e, t, r, s) {
        for (var n = e.length, i = 3; i < n; i += 4) {
          var a = e[i];
          if (0 === a) e[i - 3] = t, e[i - 2] = r, e[i - 1] = s;else if (a < 255) {
            var o = 255 - a;
      ...
      function p(e, t, r, s) {
        ...
        !function (e, t, r, s, n, i, a) {
          ...
          for (var f = Math.min(s, Math.ceil(1048576 / r)), m = 0; m < s; m += f) {
            var A = Math.min(f, s - m),
                b = e.getImageData(0, m, r, A),
                _ = t.getImageData(0, m, r, A);

            l && h(b.data, c, p, g), o(b.data, _.data, a), e.putImageData(_, 0, m);
          }
      ...
      for (var b in e.prototype = {
        beginDrawing({
          ...
          this.ctx.save(), c(this.ctx), e && this.ctx.transform.apply(this.ctx, e), this.ctx.transform.apply(this.ctx, t.transform), this.baseTransform = this.ctx.mozCurrentTransform.slice(), this.imageLayer && this.imageLayer.beginLayout();
        },
        ...
        executeOperatorList: function (e, t, r, n) {
          ...
          for (var c, h = l - o > 10 && "function" == typeof r, d = h ? Date.now() + 15 : 0, u = 0, p = this.commonObjs, g = this.objs;;) {
            ...
            if ((c = a[o]) !== s.OPS.dependency) this[c].apply(this, i[o]);else for (const e of i[o]) {
        ...
        beginSMaskGroup: function () {
          ...
          this.ctx.save();
          var o = n.context;
          o.scale(1 / e.scaleX, 1 / e.scaleY), o.translate(-e.offsetX, -e.offsetY), o.transform.apply(o, a), e.startTransformInverse = o.mozCurrentTransformInverse, l(i, o), this.ctx = o, this.setGState([["BM", "source-over"], ["ca", 1], ["CA", 1]]), this.groupStack.push(i), this.groupLevel++;
        },
        ...
        stroke: function (e) {
          ...
          if (t.globalAlpha = this.current.strokeAlpha, r && r.hasOwnProperty("type") && "Pattern" === r.type) {
            ...
            t.strokeStyle = r.getPattern(t, this), t.lineWidth = Math.max(.65 * this.getSinglePixelWidth(), this.current.lineWidth * n), t.stroke(), t.restore();
          } else t.lineWidth = Math.max(.65 * this.getSinglePixelWidth(), this.current.lineWidth), t.stroke();
        ...
        get isFontSubpixelAAEnabled() {
          ...
          for (var t = e.getImageData(0, 0, 10, 10).data, r = !1, n = 3; n < t.length; n += 4) if (t[n] > 0 && t[n] < 255) {
            r = !0;
            break;
          }
        ...
        showText: function (e) {
          ...
          i.transform.apply(i, t.textMatrix), i.translate(t.x, t.y + t.textRise), c > 0 ? i.scale(h, -1) : i.scale(h, 1);
          var b = t.lineWidth,
              _ = t.textMatrixScale;

          if (0 === _ || 0 === b) {
            var y = t.textRenderingMode & s.TextRenderingMode.FILL_STROKE_MASK;
            y !== s.TextRenderingMode.STROKE && y !== s.TextRenderingMode.FILL_STROKE || (this._cachedGetSinglePixelWidth = null, b = .65 * this.getSinglePixelWidth());
          } else b /= _;
          ...
          for (v = 0; v < d; ++v) {
            var x = e[v];
            if ((0, s.isNum)(x)) S += p * x * n / 1e3;else {
              var C,
                  k,
                  R,
                  w,
                  ...
                  M = x.accent,
                  D = x.width;
              if (u) P = x.vmetric || g, T = -(T = x.vmetric ? P[1] : .5 * D) * f, E = P[2] * f, D = P ? -P[0] : D, C = T / a, k = (S + E) / a;else C = S / a, k = 0;
              ...
              if (r.remeasure && D > 0) {
                ...
                if (D < O && this.isFontSubpixelAAEnabled) {
                  var N = D / O;
                  F = !0, i.save(), i.scale(N, 1), C /= N;
                } else D !== O && (C += (D - O) / 2e3 * n / a);
              }

              (x.isInFont || r.missingFile) && (m && !M ? i.fillText(I, C, k) : (this.paintChar(I, C, k, A), M && (R = C + M.offset.x / a, w = k - M.offset.y / a, this.paintChar(M.fontChar, R, w, A)))), S += u ? D * f - L * c : D * f + L * c, F && i.restore();
            }
          }

          u ? t.y -= S : t.x += S * h, i.restore();
        },
        showType3Text: function (e) {
          ...
          if (!(o.textRenderingMode === s.TextRenderingMode.INVISIBLE) && 0 !== c) {
            for (this._cachedGetSinglePixelWidth = null, a.save(), a.transform.apply(a, o.textMatrix), a.translate(o.x, o.y), a.scale(g, h), t = 0; t < m; ++t) if (r = e[t], (0, s.isNum)(r)) i = d * r * c / 1e3, this.ctx.translate(i, 0), o.x += i * g;else {
              var A = (r.isSpace ? p : 0) + u,
                  b = l.charProcOperatorList[r.operatorListId];
              if (b) this.processingType3 = r, this.save(), a.scale(c, c), a.transform.apply(a, f), this.executeOperatorList(b), this.restore(), n = s.Util.applyTransform([r.width, 0], f)[0] * c + A, a.translate(n, 0), o.x += n * g;else (0, s.warn)(`Type3 character "${r.operatorListId}" is not available.`);
            }
        ...
        beginGroup: function (e) {
          ...
          var a = Math.floor(n[0]),
              o = Math.floor(n[1]),
              c = Math.max(Math.ceil(n[2]) - a, 1),
              h = Math.max(Math.ceil(n[3]) - o, 1),
              d = 1,
              u = 1;
          c > 4096 && (d = c / 4096, c = 4096), h > 4096 && (u = h / 4096, h = 4096);
          var p = "groupAt" + this.groupLevel;
          e.smask && (p += "_smask_" + this.smaskCounter++ % 2);
          var g = this.cachedCanvases.getCanvas(p, c, h, !0),
              f = g.context;
          f.scale(1 / d, 1 / u), f.translate(-a, -o), f.transform.apply(f, r), e.smask ? this.smaskStack.push({
            canvas: g.canvas,
            context: f,
            offsetX: a,
            offsetY: o,
          ...
          }) : (t.setTransform(1, 0, 0, 1, 0, 0), t.translate(a, o), t.scale(d, u)), l(t, f), this.ctx = f, this.setGState([["BM", "source-over"], ["ca", 1], ["CA", 1]]), this.groupStack.push(t), this.groupLevel++, this.current.activeSMask = null;
        },
        endGroup: function (e) {
          this.groupLevel--;
          var t = this.ctx;
        ...
        beginAnnotation: function (e, t, r) {
          if (this.save(), c(this.ctx), this.current = new o(), Array.isArray(e) && 4 === e.length) {
            var s = e[2] - e[0],
                n = e[3] - e[1];
          ...
          if (o && void 0 === o.compiled && (o.compiled = s <= 1e3 && n <= 1e3 ? function (e) {
            ...
            return function (e) {
              ...
              for (let r = 0, s = _.length; r < s; r++) {
                ...
                for (let r = 2, s = t.length; r < s; r += 2) e.lineTo(t[r], t[r + 1]);
              }
            ...
            width: s,
            height: n
          }) : null), o && o.compiled) o.compiled(t);else {
        ...
        paintInlineImageXObject: function (e) {
          ...
          var i,
              a,
              o = n.mozCurrentTransformInverse,
              l = o[0],
              c = o[1],
          ...
          if ("function" == typeof HTMLElement && e instanceof HTMLElement || !e.data) i = e;else {
      ...
      }, s.OPS) e.prototype[s.OPS[b]] = e.prototype[b];
    ...
    var a = function () {
      function e(e, t, r, s, n, i, a, o) {
        ...
        if (!(g >= b)) for (var _, y, v, S, x, C, k, R, w = h[i], P = h[i + 1], T = h[i + 2], E = h[a], F = h[a + 1], L = h[a + 2], I = h[o], M = h[o + 1], D = h[o + 2], O = Math.round(g), N = Math.round(b), j = O; j <= N; j++) {
          if (j < m) {
            let e;
            e = j < g ? 0 : g === m ? 1 : (g - j) / (g - m), _ = p - (p - f) * e, y = w - (w - E) * e, v = P - (P - F) * e, S = T - (T - L) * e;
          } else {
            let e;
          ...
          let e;
          e = j < g ? 0 : j > b ? 1 : (g - j) / (g - b), x = p - (p - A) * e, C = w - (w - I) * e, k = P - (P - M) * e, R = T - (T - D) * e;

          for (var U = Math.round(Math.min(_, x)), q = Math.round(Math.max(_, x)), W = u * j + 4 * U, G = U; G <= q; G++) e = (_ - G) / (_ - x), e < 0 ? e = 0 : e > 1 && (e = 1), d[W++] = y - (y - C) * e | 0, d[W++] = v - (v - k) * e | 0, d[W++] = S - (S - R) * e | 0, d[W++] = 255;
        }
      }
      ...
      return function (e, r, s, n, i, a, o, l) {
        ...
        if (l.isEnabled) c = l.drawFigures({
          ...
          figures: i,
          context: v
        }), (h = o.getCanvas("mesh", S, x, !1)).context.drawImage(c, 2, 2), c = h.canvas;else {
          ...
          if (a) {
            ...
            for (d = 0, u = R.length; d < u; d += 4) R[d] = a[0], R[d + 1] = a[1], R[d + 2] = a[2], R[d + 3] = 255;
          }
      ...
      fromIR: function (e) {
        ...
        return {
          ...
          getPattern: function (e, d, u) {
            var p;
            if (i(e, c), u) p = s.Util.singularValueDecompose2dScale(e.mozCurrentTransform);else if (p = s.Util.singularValueDecompose2dScale(d.baseTransform), l) {
      ...
      constructor(e, t, r) {
        this.sourceName = e, this.targetName = t, this.comObj = r, this.callbackId = 1, this.streamId = 1, this.postMessageTransfers = !0, this.streamSinks = Object.create(null), this.streamControllers = Object.create(null), this.callbackCapabilities = Object.create(null), this.actionHandler = Object.create(null), this._onComObjOnMessage = e => {
          ...
          if (t.callback) {
            ...
            if (delete this.callbackCapabilities[e], t.callback === n) r.resolve(t.data);else {
    ...
    t.Metadata = class {
      ...
      _parse(e) {
        ...
        for (let e = 0, t = s.length; e < t; e++) {
          const t = s[e];
          if ("rdf:description" === t.nodeName.toLowerCase()) for (let e = 0, r = t.childNodes.length; e < r; e++) if ("#text" !== t.childNodes[e].nodeName.toLowerCase()) {
    ...
    t.SimpleXMLParser = class extends class {
          ...
          if ("<" === e[t]) {
            ...
            switch (++r, e[r]) {
              ...
              default:
                ...
                let d = !1;
                if ("/>" === e.substring(r + h.parsed, r + h.parsed + 2)) d = !0;else if (">" !== e.substring(r + h.parsed, r + h.parsed + 1)) return void this.onError(c);
      ...
      onText(e) {
        if (function (e) {
          for (let t = 0, r = e.length; t < r; t++) if (!h(e, t)) return !1;
          ...
          for (f = 0, m = h.length; f < m; f++) {
            ...
            switch (k.type) {
              case "lattice":
                ...
                for (var T = 1; T < A; T++) for (var E = T * P + 1, F = 1; F < P; F++, E++) _[x] = v[R[E - P - 1]], _[x + 1] = v[R[E - P - 1] + 1], _[x + 2] = v[R[E - P]], _[x + 3] = v[R[E - P] + 1], _[x + 4] = v[R[E - 1]], _[x + 5] = v[R[E - 1] + 1], y[C] = S[w[E - P - 1]], y[C + 1] = S[w[E - P - 1] + 1], y[C + 2] = S[w[E - P - 1] + 2], y[C + 3] = S[w[E - P]], y[C + 4] = S[w[E - P] + 1], y[C + 5] = S[w[E - P] + 2], y[C + 6] = S[w[E - 1]], y[C + 7] = S[w[E - 1] + 1], y[C + 8] = S[w[E - 1] + 2], _[x + 6] = _[x + 2], _[x + 7] = _[x + 3], _[x + 8] = _[x + 4], _[x + 9] = _[x + 5], _[x + 10] = v[R[E]], _[x + 11] = v[R[E] + 1], y[C + 9] = y[C + 3], y[C + 10] = y[C + 4], y[C + 11] = y[C + 5], y[C + 12] = y[C + 6], y[C + 13] = y[C + 7], y[C + 14] = y[C + 8], y[C + 15] = S[w[E]], y[C + 16] = S[w[E] + 1], y[C + 17] = S[w[E] + 2], x += 12, C += 18;

                break;

              case "triangles":
                for (var L = 0, I = R.length; L < I; L++) _[x] = v[R[L]], _[x + 1] = v[R[L] + 1], y[C] = S[w[L]], y[C + 1] = S[w[L] + 1], y[C + 2] = S[w[L] + 2], x += 2, C += 3;
    ...
    var s = r(1),
      ...
      function t(t, r, n) {
        ...
        if (h.ascent ? u = h.ascent * u : h.descent && (u = (1 + h.descent) * u), 0 === c ? (p = l[4], g = l[5] - u) : (p = l[4] + u * Math.sin(c), g = l[5] - u * Math.cos(c)), a.style.left = `${p}px`, a.style.top = `${g}px`, a.style.fontSize = `${d}px`, a.style.fontFamily = h.fontFamily, a.textContent = r.str, t._fontInspectorEnabled && (a.dataset.fontName = r.fontName), 0 !== c && (o.angle = c * (180 / Math.PI)), r.str.length > 1 && (h.vertical ? o.canvasWidth = r.height * t._viewport.scale : o.canvasWidth = r.width * t._viewport.scale), t._textDivProperties.set(a, o), t._textContentStream && t._layoutText(a), t._enhanceTextSelection) {
          ...
          var A,
              b,
              _ = (h.vertical ? r.height : r.width) * t._viewport.scale,
              y = d;
        ...
        for (var t = e._bounds, r = e._viewport, i = function (e, t, r) {
          ...
          if (0 !== c.angle) {
            var h = i[o],
                ...
                p = u[0],
                g = u[1],
                f = [[0, 0], [0, d.size[1]], [d.size[0], 0], d.size],
                m = new Float64Array(64);
            f.forEach(function (e, t) {
              var r = s.Util.applyTransform(e, u);
            ...
            c.paddingLeft = n(m, 32, 16) / A, c.paddingTop = n(m, 48, 16) / A, c.paddingRight = n(m, 0, 16) / A, c.paddingBottom = n(m, 16, 16) / A, e._textDivProperties.set(l, c);
      ...
      function a(e, t) {
        ...
        t.forEach(function (e) {
          ...
          })), a = t; a <= i; a++) if (void 0 === (n = (s = r[a]).boundary).x2New) {
            var p = !1;
      ...
      return o.prototype = {
        ...
        expandTextDivs: function (e) {
          ...
          for (var s = 0, n = this._textDivs.length; s < n; s++) {
    ...
    t.SVGGraphics = a;
    {
      const e = {
        ...
        function n(e) {
          ...
          for (; t > 65535;) s[n++] = 0, s[n++] = 255, s[n++] = 255, s[n++] = 0, s[n++] = 0, s.set(e.subarray(i, i + 65535), n), n += 65535, i += 65535, t -= 65535;

          s[n++] = 1, s[n++] = 255 & t, s[n++] = t >> 8 & 255, s[n++] = 255 & ~t, s[n++] = (65535 & ~t) >> 8 & 255, s.set(e.subarray(i), n), n += e.length - i;
          ...
          return s[n++] = a >> 24 & 255, s[n++] = a >> 16 & 255, s[n++] = a >> 8 & 255, s[n++] = 255 & a, s;
        }
      ...
      t.SVGGraphics = a = class {
        ...
        loadDependencies(e) {
          ...
          for (let e = 0, n = t.length; e < n; e++) if (t[e] === s.OPS.dependency) for (const t of r[e]) {
        ...
        _makeTilingPattern(e) {
          ...
          const x = this.svg,
                ...
                R = this.current.strokeColor,
                w = this.svgFactory.create(f - p, A - g);

          if (this.svg = w, this.transformMatrix = n, 2 === d) {
            const e = s.Util.makeCssRgb(...t);
            this.current.fillColor = e, this.current.strokeColor = e;
          }

          return this.executeOpTree(this.convertOpList(r)), this.svg = x, this.transformMatrix = C, this.current.fillColor = k, this.current.strokeColor = R, S.appendChild(w.childNodes[0]), this.defs.appendChild(S), `url(#${u})`;
        }
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      if (404 === e || 0 === e && t.startsWith("file:")) return new s.MissingPDFException('Missing PDF "' + t + '".');
      ...
      return i.allowRangeRequests = !0, i;
      ...
      function a(e) {
        if (e.startsWith('"')) {
          ...
          for (let e = 0; e < t.length; ++e) {
            const r = t[e].indexOf('"');
            -1 !== r && (t[e] = t[e].slice(0, r), t.length = e + 1), t[e] = t[e].replace(/\\(.)/g, "$1");
          }
