...
var FontInspector = function FontInspectorClosure() {
  ...
  return {
    ...
    fontAdded: function fontAdded(fontObj, url) {
      ...
      fonts.appendChild(font); // Somewhat of a hack, should probably add a hook for when the text layer
      // is done rendering.
...
var opMap; // Manages all the page steppers.
...
window.PDFBug = function PDFBugClosure() {
  ...
  return {
    ...
    init(pdfjsLib, container) {
      ...
      container.style.right = panelWidth + "px"; // Initialize all the debugging tools.
